...
useEffect(()=>{
  ...
  useEffect(() => {
    ...
    return (
        <>
        <Login/>
            <div className={ ` z-10  max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 transition-all ease-in-out right-0 ${bgColor}`}>
                <div className="navbar  ">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        {/* btn */}
                        <div >
                            <a className=" bg-black text-white p-2 px-3 rounded-md hover:bg-slate-800 cursor-pointer duration-300 capitalize"  onClick={()=>document.getElementById('my_modal_3').showModal()}>login</a>
                            <Login/>
                        </div>
                    </div>
